...
import ui.MaintainerRole.MaintainerWorkAreaJPanel;
...
public class MaintainerRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization,
        ...
        return new MaintainerWorkAreaJPanel(userProcessContainer, account, (MaintenanceOrganization) organization,
                enterprise);
    }
